...
public final class Constants {
  ...
  public static final CANdiConfiguration ELEVATOR_CANDI_CONFIGS = new CANdiConfiguration()
    .withDigitalInputs(
  ...
  public static final Distance ELEVATOR_SPROCKET_RADIUS = Inches.of(.6405);
